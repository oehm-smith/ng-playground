...
export class DialogService {
  ...
  public showConfirmDialog(message: string, okCallback: () => any, cancelCallback: () => any) {
    console.log('showConfirmDialog - message: ', message);
  ...
  public showDeletePromptDialog(msgHtml: string, okCallback: (reason : string) => any, cancelCallback: () => any) : string {
    console.log('showDeletePromptDialog - msgHtml: ', msgHtml);
    return 'yes';
  ...
  public showAlertDialog(message: string) {
    ...
    console.log('showAlertDialog - message: ', message);
  }
  ...
  public showSuccessMessage(message: string) {
    ...
    console.log('showSuccessMessage - message: ', message);
  }
  ...
  public showErrorMessage(message: string) {
    ...
    console.log('showErrorMessage - message: ', message);
  }
  ...
  public showLogMessage(message: string) {
    ...
    console.log('showLogMessage - message: ', message);
  }
